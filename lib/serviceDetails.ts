...
export const serviceDetails: ServiceDetail[] = [
  ...
  },
  {
    ...
    faqs: [
      { q: { en: "Do you offer emergency roadside service?", es: "¿Ofrecen servicio de emergencia en carretera?" }, a: { en: "Yes. We offer roadside and on-site emergency repair during business hours. Call us and we'll get to your breakdown as fast as possible.", es: "Si. Ofrecemos reparacion de emergencia en carretera y en sitio durante el horario de trabajo. Llamanos y llegaremos a tu averia lo mas rapido posible." } },
